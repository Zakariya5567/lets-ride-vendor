            ...
            GetBuilder<AuthController>(builder: (authController) {
              return Column(children: [
                    ...
                    child: Container(
                      ...
                      child: Column(children: [
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          Image.asset(Images.document,color: Colors.white ,width: 40, height: 30),
                          ...
                          Expanded(child: Column(children: [
                            Text(
                              ...
                              style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).cardColor),
                                 ...
                                 SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        Text(
                          authController.profileModel != null ?     authController.profileModel.verifiedDocument.toString() : '0',
                          style: robotoBold.copyWith(fontSize: 14, color: Theme.of(context).cardColor),
                        ),
                            
                          ])),
                          Container(height: 20, width: 1, color: Theme.of(context).cardColor),
                                                    Expanded(child: Column(children: [
                            Text(
                              'pending'.tr+"",
                              style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).cardColor),
                             ...
                             SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        Text(
                          authController.profileModel != null ?     authController.profileModel.pendingDocument.toString() : '0',
                          style: robotoBold.copyWith(fontSize: 14, color: Theme.of(context).cardColor),
                        ),
                          ...
                          Expanded(child: Column(children: [
                            ...
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                             Text(
                          authController.profileModel != null ?     authController.profileModel.rejectedDocument.toString() : '0',
                          style: robotoBold.copyWith(fontSize: 14, color: Theme.of(context).cardColor),
                        ),
                ...
                Container(
                  ...
                  child: Column(children: [
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Image.asset(Images.wallet, width: 50, height: 50),
