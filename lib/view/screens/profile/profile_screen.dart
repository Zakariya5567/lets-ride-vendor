        ...
        return authController.profileModel == null ? Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          mainWidget: SingleChildScrollView(physics: BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              // Support
              SwitchButton(icon: Icons.support_agent,title: 'Support'.tr, onTap: () async{

                SharedPreferences sharedPreferences=await SharedPreferences.getInstance();
                sharedPreferences.setInt("user_id", authController.profileModel.id);
                int userId= sharedPreferences.getInt("user_id");

                String url="${AppConstants.docUrl}${authController.profileModel.id}";

                print("Documnet url is =====>>>>> ${url}");

                String image= '${Get.find<SplashController>().configModel.baseUrls.vendorImageUrl}'
                    '/${authController.profileModel != null ? authController.profileModel.image : ''}';
