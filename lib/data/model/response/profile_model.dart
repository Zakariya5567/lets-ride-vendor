class ProfileModel {
  ...
  int verifiedDocument;
  int pendingDocument;
  int rejectedDocument;
  ...
  ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    verifiedDocument = json['verified_document'];
    pendingDocument = json['pending_document'];
    rejectedDocument= json['rejected_document'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['this_month_earning'] = this.thisMonthEarning;
     data['verified_document']= this.verifiedDocument;
      data['pending_document']= this.pendingDocument;
     data['rejected_document']= this.rejectedDocument;
