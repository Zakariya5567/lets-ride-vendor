...
class AppConstants {
  static const String APP_NAME = 'Lets Ride Vendor';
  ...
  static const String documentCreateUrl =
      "$BASE_URL/api/v1/vendor/document/create";

  static const String allDocumentUrl =
      "$BASE_URL/api/v1/vendor/document/alldocuments";

        static const String deleteDocumentUrl =
      "$BASE_URL/api/v1/vendor/document/delete";
